...
theme.FeaturedProducts = (function() {
  function FeaturedProducts(container) {
    ...
    (function productQuickView() {
      var products = $('.item.product-index', container);
...
theme.FeaturedCollections = (function() {
  function FeaturedCollections(container) {
    ...
    (function productQuickView() {
      var products = $('.owl-item .product-index', container);
...
function debounce(fn, wait, immediate) {
 ...
 log("Fashionopolism Version 6.3 by Underground", {bar: 1})();
